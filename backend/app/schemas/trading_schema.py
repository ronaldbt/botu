...
class UpdateCryptoAllocationRequest(BaseModel):
    ...
    def validate_crypto(cls, v):
        valid_cryptos = ['btc', 'btc_30m', 'btc_30m_testnet', 'btc_30m_mainnet', 'btc_4h_mainnet', 'paxg_4h_mainnet', 'bnb_mainnet', 'bnb_4h_mainnet', 'eth_mainnet', 'eth_4h_mainnet', 'eth', 'bnb']
