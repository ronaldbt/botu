        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <select 
              ...
              class="w-full appearance-none bg-white border border-slate-300 rounded-lg px-3 py-2 text-slate-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
            >
