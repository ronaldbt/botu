...
class Bitcoin15mStrategyBacktest:
    ...
    def get_historical_data_2024(self):
        ...
        """
        print("📊 Obteniendo datos históricos de Bitcoin para 2024 (15m)...")
        ...
        print(f"🎯 DATOS BITCOIN 2024 COMPLETO (15m):")
    ...
    def backtest_2024_complete(self):
        """
        Backtesting completo de todo el año 2024 con intervalos de 15m
        USANDO LA ESTRATEGIA EXACTA DE bitcoin_2023_backtest.py
        """
        print("🚀 BACKTESTING BITCOIN - AÑO COMPLETO 2024 (15m)")
        print("="*80)
        print("⚡ Usando estrategia EXACTA de bitcoin_2023_backtest.py")
        print("🎯 Solo cambios: 4% TP, 1.5% SL, 96 períodos max hold (30min strategy)")
        ...
        max_hold_periods = 96     # 96 períodos de 15min = 24 horas (equivalente a 48 períodos de 30min)
        
        # Ventana de análisis (escalada proporcionalmente)
        window_size = 48          # 48 períodos de 15min = 12 horas (equivalente a 24 períodos de 30min)
        step_size = 4             # Cada 4 períodos = 1 hora (equivalente a 2 períodos de 30min)
        
        total_windows = (len(df) - window_size) // step_size
        print(f"🔄 Analizando {total_windows} ventanas de trading...")
        print("⚡ Configuración: 4% profit target | 1.5% stop loss | Max 24h holding")
        print()
    ...
    def _generate_2024_report(self, monthly_performance, monthly_trades, df):
        ...
        """
        print()
        print("📊 REPORTE COMPLETO - BITCOIN AÑO 2024 (15m - ESTRATEGIA BITCOIN_2023_BACKTEST)")
        print("="*80)
...
def main():
    """Función principal"""
    print("🚀 Iniciando backtest Bitcoin 15m con estrategia EXACTA de bitcoin_2023_backtest.py...")
