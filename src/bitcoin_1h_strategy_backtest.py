# src/bitcoin_1h_strategy_backtest.py
# Backtesting de Bitcoin para todo el año 2024 usando intervalos de 1 hora
# Usando EXACTAMENTE la estrategia de bitcoin_2023_backtest.py con parámetros de 30min
...
class Bitcoin1hStrategyBacktest:
    ...
    def get_historical_data_2024(self):
        ...
        """
        print("📊 Obteniendo datos históricos de Bitcoin para 2024 (1h)...")
    ...
    def backtest_2024_complete(self):
        """
        Backtesting completo de todo el año 2024 con intervalos de 1h
        ...
        print("🎯 Solo cambios: 4% TP, 1.5% SL, 48h max hold (30min strategy)")
        ...
        # PARÁMETROS DE 30MIN EXITOSO (solo estos cambian)
        profit_target = 0.040     # 4.0% take profit
        stop_loss = 0.015         # 1.5% stop loss  
        max_hold_periods = 48     # 48 horas máximo (equivalente a 24h en 30min)
        
        # Ventana de análisis (escalada proporcionalmente)
        window_size = 24          # 24 horas (equivalente a 12h en 30min)
        step_size = 2             # Cada 2 horas (equivalente a 1h en 30min)
        
        total_windows = (len(df) - window_size) // step_size
        print(f"🔄 Analizando {total_windows} ventanas de trading...")
        print("⚡ Configuración: 4% profit target | 1.5% stop loss | Max 48h holding")
        print()
    ...
    def _generate_2024_report(self, monthly_performance, monthly_trades, df):
        ...
        """
        print()
        print("📊 REPORTE COMPLETO - BITCOIN AÑO 2024 (1h - ESTRATEGIA BITCOIN_2023_BACKTEST)")
        print("="*80)
        ...
        print(f"🏆 RESUMEN EJECUTIVO BITCOIN 2024 (1h - ESTRATEGIA ORIGINAL):")
        ...
        print(f"📊 ESTADÍSTICAS DE TRADING (1h - ESTRATEGIA ORIGINAL):")
...
def main():
    """Función principal"""
    print("🚀 Iniciando backtest Bitcoin 1h con estrategia EXACTA de bitcoin_2023_backtest.py...")
    backtest = Bitcoin1hStrategyBacktest(initial_capital=1000)
