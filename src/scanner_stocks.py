# src/scanner_stocks.py
# Scanner dedicado exclusivamente para acciones usando Yahoo Finance
...
# Parámetros originales para ACCIONES (sin cambios)
RUPTURE_FACTOR = 1.02
MIN_SLOPE_LEFT = -0.5
...
def scan_stocks_for_u(ticker, verbose=False):
    """
    Scanner ORIGINAL para acciones - SIN MODIFICACIONES
    Mantiene la lógica exacta del scanner.py original
    """
    log(f"📈 [STOCKS] Escaneando {ticker} con datos Yahoo Finance...")
